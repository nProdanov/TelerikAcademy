...
using Dealership.Logger;
using Dealership.Reader;
...
namespace Dealership.Engine
{
    public sealed class DealershipEngine : IEngine
    {
        ...
        private IVehicleHandler startHandler;
        ...
        {
            IVehicle vehicle = this.startHandler.HandleVehicle(type, make, model, price, additionalParam);
